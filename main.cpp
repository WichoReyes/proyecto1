...
int main ()
{
    BITMAP *buffer,*bmp,*bmp2,*notas,*boton, *cursor, *blanca,*redonda,*corchea;
    bool botoon=false;
    char n;
    int i=0,j=0,x=350, numero,duracion;
    struct Nota c1;
    allegro_init();
    install_keyboard();
    install_mouse();
   ...
   // duracion=c1.duracion[i][0]*1000+c1.duracion[i][1]*100+c1.duracion[i][2]*10+c1.duracion[i][3];
    cout<<numero;
    ...
    else if(numero>=293.6 && numero<329.6)
    {
        ...
        blit(redonda,buffer,0,0,x,260,21,43);
        x=x+30;
        }else if(duracion==500){
    ...
    else if(numero>=329.6 && numero<349.2)
    {
        ...
        blit(redonda,buffer,0,0,x,250,21,43);
        x=x+30;
        }else if(duracion==500){
    ...
    else if(numero>=349.2 && numero<391.9)
    {
        ...
        blit(redonda,buffer,0,0,x,240,21,43);
        x=x+30;
        }else if(duracion==500){
    ...
    else if(numero>=391.9 && numero<440)
    {
        ...
        blit(redonda,buffer,0,0,x,230,21,43);
        x=x+30;
        }else if(duracion==500){
    ...
    else if(numero>=440 && numero<493.8)
    {
        ...
        blit(redonda,buffer,0,0,x,220,21,43);
        x=x+30;
        }else if(duracion==500){
    ...
    else if(numero>=493.8 && numero<523.2)
    {
        ...
        blit(redonda,buffer,0,0,x,210,21,43);
        x=x+30;
        }else if(duracion==500){
    ...
    else if(numero>=523.2)
    {
        ...
        blit(redonda,buffer,0,0,x,200,21,43);
        x=x+30;
        }else if(duracion==500){
